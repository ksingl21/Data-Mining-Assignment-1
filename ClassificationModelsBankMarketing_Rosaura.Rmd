...
gbm_M1Trn<- predict(gbm_M1_1000_0.025, newdata = mdTrn, n.tree= bestIter_1000_0.25, type="response")
head(scores_gbmM1)

#Test Data, kept at n=1000 and shrinkage is 0.025
gbm_M1Tst <- gbm(formula=unclass(y)-1 ~., data=mdTst,distribution = "bernoulli", n.trees=1000, shrinkage=0.025, interaction.depth = 4, bag.fraction=0.5, cv.folds = 5,  n.cores=NULL)  
...
#naive-Bayes model - choosing nbm2
